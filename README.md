...
PojavBounceNew is a free and open-source mixin-based injection hacked client using the Fabric API for Minecraft.And it based on Rubbishy-Liquidbounce-NextGen For Android.I(80%) and Geda6(20%) used DeepSeek and AutoClaw to develop this project.And I skided ArrayList and Browserbackend.kt from Rubbishy-Liquidbounce and I fixed them.Thanked to Rubbishy-Liquidbounce and it provided minecraft src. I want the latest LiquidBounce NextGen can work on Android.
